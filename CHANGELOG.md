...
- **245 new CSS animation effects** — every category now ships exactly 100 effects:
  - **Buttons** — 50 → 100: ambient entrance, kinetic, hover-reveal, and icon-swap effects including `sds-btn-beacon`, `sds-btn-blinds`, `sds-btn-breath-hold`, `sds-btn-draw-corners`, `sds-btn-draw-cross`, `sds-btn-draw-dash`, `sds-btn-draw-path`, `sds-btn-elastic-pop`, `sds-btn-fade-steps`, `sds-btn-flash-fill`, `sds-btn-ghost-fill`, `sds-btn-glow-wave`, `sds-btn-gravity-drop`, `sds-btn-ice-crack`, `sds-btn-icon-launch`, `sds-btn-label-slide`, `sds-btn-label-typewrite`, `sds-btn-label-wave`, `sds-btn-neon-border-trace`, `sds-btn-nudge`, `sds-btn-orbit-glow`, `sds-btn-particle-burst`, `sds-btn-blink`, `sds-btn-shatter`, `sds-btn-shimmer-border`, `sds-btn-slide-reveal`, `sds-btn-snap-scale`, `sds-btn-spin-settle`, `sds-btn-spotlight-wipe`, `sds-btn-static-burst`, `sds-btn-swap-flip`, `sds-btn-timer-fill`, `sds-btn-tractor-beam`, `sds-btn-unravel`, `sds-btn-vhs-glitch`, `sds-btn-wave-wipe`, `sds-btn-wipe-down`, `sds-btn-wipe-up`, `sds-btn-wireframe`, `sds-btn-xray`, `sds-btn-zoom-blur`, `sds-btn-zoom-in`, `sds-btn-zoom-out`, `sds-btn-zoom-punch`, `sds-btn-comet-trail`, `sds-btn-halo-expand`, `sds-btn-ripple-out`, `sds-btn-spark-trail`, `sds-btn-spiral-in`
  - **Inputs** — 51 → 100: validation, ambient, typewriter, and liquid effects
  - **Cards** — 49 → 100: 3D perspective, choreography, and reveal effects including `sds-card-accordion-in`, `sds-card-checker`, `sds-card-fan-spread`, `sds-card-layers`, `sds-card-reveal-stack`
  - **Loaders** — 51 → 100: dots families, ring variants, geometric spinners, glow/filter effects, and finale group (154–165) including `sds-loader-dots-wave`, `sds-loader-dots-fade`, `sds-loader-dots-flip`, `sds-loader-dots-bounce`, `sds-loader-dots-expand`, `sds-loader-blob`, `sds-loader-bubble`, `sds-loader-dual-ring`, `sds-loader-ring-split`, `sds-loader-spin-dot`, `sds-loader-ring-chase`, `sds-loader-eclipse`, `sds-loader-halo`, `sds-loader-fill-bar`, `sds-loader-bar-pulse`, `sds-loader-bar-swing`, `sds-loader-track`, `sds-loader-stripes`, `sds-loader-equalizer`, `sds-loader-morph-geo`, `sds-loader-fold`, `sds-loader-pinwheel`, `sds-loader-coil`, `sds-loader-flip-card`, `sds-loader-diamond`, `sds-loader-squares`, `sds-loader-isocube`, `sds-loader-metronome`, `sds-loader-tape`, `sds-loader-chase-box`, `sds-loader-windmill`, `sds-loader-glow-pulse`, `sds-loader-neon-flicker`, `sds-loader-scanner`, `sds-loader-spotlight`, `sds-loader-beam`, `sds-loader-blur-pulse`, `sds-loader-timer`, `sds-loader-cursor`, `sds-loader-bounce-bar`, `sds-loader-ripple-dot`, `sds-loader-yo-yo`, `sds-loader-swivel`, `sds-loader-gear`, `sds-loader-drop`, `sds-loader-ticker`, `sds-loader-expand-ring`, `sds-loader-spin-fade`, `sds-loader-throb`
